 ...
 * controls -- always rendered above the grid, by construction (it's the
 * only place in the parent's InnerBlocks area gateway/facet is allowed to
 * live; see gateway/facet's own "parent" restriction in its block.json).
 *

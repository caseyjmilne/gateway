 ...
 * from `$content`): this plain wrapper `<div>` exists only to hold the
 * real InnerBlocks (the user's authored card template) delimiter comments
 * for storage/parsing purposes -- it's never actually output to a visitor.

 ...
 * needs a "how many items per page" setting -- for gateway/data-cards,
 * this maps to `Data_Cards_Renderer`'s own `posts_per_page`/length-menu
 * logic (PHP-side). Accepts only positive integers; unlike Limit, 0

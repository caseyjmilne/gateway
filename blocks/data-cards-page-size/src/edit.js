 ...
 * gateway/data-cards-page-size doesn't need a *live* editor sync: there's
 * no live front-end instance to sync with in the editor at all
 * (gateway/data-cards-body's own editor preview is real InnerBlocks +
 * useBlockPreview editing, not a server-rendered grid -- see its own
 * edit.js), but context alone is already everything render.php itself
 * needs, so the preview can still be accurate rather than a hardcoded
 * placeholder list.
 *
 * @param {Object} props

...
require_once GATEWAY_PLUGIN_DIR . 'includes/class-date-field-type.php';
require_once GATEWAY_PLUGIN_DIR . 'includes/class-time-field-type.php';
require_once GATEWAY_PLUGIN_DIR . 'includes/class-datetime-field-type.php';
...
require_once GATEWAY_PLUGIN_DIR . 'includes/class-page-link-field-type.php';
...
function gateway_boot() {
	...
	\Gateway\Field_Type_Registry::register( \Gateway\Date_Field_Type::class );
	\Gateway\Field_Type_Registry::register( \Gateway\Time_Field_Type::class );
	\Gateway\Field_Type_Registry::register( \Gateway\Datetime_Field_Type::class );
	...
	\Gateway\Field_Type_Registry::register( \Gateway\Page_Link_Field_Type::class );
